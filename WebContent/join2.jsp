        ...
        <div class="contents">
             ...
             <div class="joinform">
                ...
                <form action="joinAction.jsp" method="POST">
                    <p>
                        <label class="txt_star" for="" name="id" id="join_label">아이디</label>
                        <input type="text" name="m_id">
                        <a href="idcheck.jsp">아이디 중복확인</a>
                    </p>
                    <p>
                        <label class="txt_star" for="" name="id" id="join_label">비밀번호</label>
                        <input type="password" name="m_pwd">
                        <span>6 - 15자 이상 : 영문, 숫자 조합 </span>
                    </p>
                    <p>
                        <label class="txt_star" for="" name="id" id="join_label">이름</label>
                    ...
                    <p>
                        <label class="txt_star" for="" name="id" id="join_label">휴대폰 번호</label>
                        <input type="text" name="m_phoneNum">
                    </p>
